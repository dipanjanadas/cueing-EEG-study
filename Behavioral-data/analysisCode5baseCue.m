...
%     
%     
%     deleteCongInvalidRT3= [find(congVecInvalid(:,1)<200)];
...
%     
%     deleteIncongInvalidRT3=[find(incongVecInvalid(:,1)<200)];
...
%     baselineData(sub,3)=meanCongInvalidRT;
%     baselineData(sub,4)=meanIncongInvalidRT;
%     baselineData(sub,5)=meanCongNPRT;
%     baselineData(sub,6)=meanIncongNPRT;
% %     baselineData(sub,7)=meanCongNeutRT;
% %     baselineData(sub,8)=meanIncongNeutRT;
    baselineData(sub,3)=congValidPC;
    baselineData(sub,4)=incongValidPC;
%     baselineData(sub,9)=congInvalidPC;
%     baselineData(sub,10)=incongInvalidPC;
%     baselineData(sub,11)=congNPPC;
%     baselineData(sub,12)=incongNPPC;
%     baselineData(sub,15)=congNeutPC;
%     baselineData(sub,16)=incongNeutPC;

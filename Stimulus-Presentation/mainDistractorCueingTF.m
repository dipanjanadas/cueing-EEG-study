...
trialLog(1).experiment='mainDistractorCueingExp';
trialLog(1).age=age;
...
if eyetracker == 1
    EyelinkInit([], 1);
    edfFile = [num2str(sjNum) '_' 'dc' '.edf']; % Name of eyetracking data file - has to be in the working directory unfortunately
...
trialMatrix=[cue;dist;targ;congMatrix;tOrient;dOrient;trialType];
    ...
    while i<=nTrials     %for future ref, don't do: 'while i<= 1:nTrials'. it won't work!
        ...
        while keepchecking == 1;
            ...
            if x>50 && y>50
                ...
                Screen('DrawText', window, 'o', x, y,greenFix);
            end
...
%                 break out of trial
        ...
        if mod(sjNum,2)>0 %odd numbered subjects red is the distractor cue
            if thisCue==1
        ...
        else %even numbered subjects blue is the distractor cue
            if thisCue==1
    ...
    save(sprintf('s%02d_mainDistractorCueingTFexp', sjNum),'trialLog');
